    ...
    internal class RoundManagerPatch
    {
        ...
        static void spawnLasers(ref RoundManager __instance)
        {
            ...
            if (!HostCheck) {
                ...
                Collider[] hitColliders = Physics.OverlapSphere(rear, 3f);
            ...
            for (int i=0;i<spawnAmount;i++)
            {
                ...
                GameObject val = UnityEngine.Object.Instantiate<GameObject>(StartOfRound.Instance.allItemsList.itemsList[zapGunID].spawnPrefab, front, Quaternion.identity);
